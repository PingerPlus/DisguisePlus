...
import net.pinger.disguise.prompts.world.AddWorldPrompt;
...
public class WorldListProvider implements InventoryProvider {
    ...
    private ItemStack getWorldStack(String name, int state) {
        ...
        // Name
        builder.setName(new TwoWayLoadingMask(ChatColor.GREEN, ChatColor.GRAY).getMaskedString(name, state));

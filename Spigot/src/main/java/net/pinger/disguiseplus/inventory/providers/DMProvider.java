...
import net.pinger.disguiseplus.prompts.chat.SetFormatPrompt;
import net.pinger.disguiseplus.prompts.chat.prefix.SetDefaultPrefixPrompt;
import net.pinger.disguiseplus.prompts.chat.prefix.SetDisguisedPrefixPrompt;
import net.pinger.disguiseplus.prompts.chat.suffix.SetDefaultSuffixPrompt;
import net.pinger.disguiseplus.prompts.chat.suffix.SetDisguisedSuffixPrompt;
